...
public class StageTwo extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        OurSong = MediaPlayer.create(StageTwo.this,R.raw.stage_sound);
        ...
        Yes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent stage = new Intent(com.example.aldrinmcadelia.myapplication.StageTwo.this,StagePage.class);
                startActivity(stage);
                finish();
            }
        });
    ...
    private int loadSavedPreferences() {
        ...
        return sharedPreferences.getInt("Stage2Time", 20000);
    }
        ...
        public void run() {
            ...
            while (ball.getI()!=numMaze.getRow()-1 || ball.getJ()!=numMaze.getColumn()-1){
                try {
                    ...
                    canvas.drawText("Stage 2", (width-1*str1.toString().length())/(float)20, (height-numMaze.getRight()+numMaze.getOffset())/(float)2, nPaint);
                    canvas.drawText("Limit: 20s", (width-1*str1.toString().length())/(float)1.5, (height-numMaze.getRight()+numMaze.getOffset())/(float)1.5, mPaint);
            ...
            if (canvas!=null){
                ...
                if (best==false && timer<Btime){
                    best=true;
                    savePreferences("Stage2Time",timer);
                }
                numMaze.drawMaze(canvas, mPaint);
            ...
            if(gameOver!=true){
                if(timer<Btime){
                    Intent finish = new Intent(com.example.aldrinmcadelia.myapplication.StageTwo.this,StagePage.class);
            ...
            if(gameOver==true){
                finish();
                Intent intent = new Intent(com.example.aldrinmcadelia.myapplication.StageTwo.this,GameOver.class);
                intent.putExtra("stageNo",2);
