...
public class StageNine extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Yes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent stage = new Intent(com.example.aldrinmcadelia.myapplication.StageNine.this,StagePage.class);
                startActivity(stage);
                finish();
            }
        });
        ...
        public void run() {
            ...
            while (ball.getI()!=numMaze.getRow()-1 || ball.getJ()!=numMaze.getColumn()-1){
                try {
                    ...
                    canvas.drawText("Stage 9", (width-1*str1.toString().length())/(float)20, (height-numMaze.getRight()+numMaze.getOffset())/(float)2, nPaint);
                    canvas.drawText("Limit: 40s", (width-1*str1.toString().length())/(float)1.5, (height-numMaze.getRight()+numMaze.getOffset())/(float)1.5, mPaint);
            ...
            if(gameOver!=true){
                if(timer<Btime){
                    Intent finish = new Intent(com.example.aldrinmcadelia.myapplication.StageNine.this,StagePage.class);
            ...
            if(gameOver==true){
                finish();
                Intent gameOver = new Intent(com.example.aldrinmcadelia.myapplication.StageNine.this,GameOver.class);
                gameOver.putExtra("stageNo",9);
