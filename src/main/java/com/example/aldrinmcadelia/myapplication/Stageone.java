...
public class Stageone extends Activity implements SensorEventListener
{
    ...
    private int loadSavedPreferences() {
        ...
        return sharedPreferences.getInt("stage1", 20000);
    }
...
//        Thread.currentThread().interrupt();
    ...
    class MyThread implements Runnable{
        ...
        public void run() {
            ...
            if(gameOver!=true){
                if(timer<Btime){
                    Intent finish = new Intent(com.example.aldrinmcadelia.myapplication.Stageone.this,StagePage.class);
            ...
            if(gameOver==true){
                finish();
                Intent gameOver = new Intent(com.example.aldrinmcadelia.myapplication.Stageone.this,GameOver.class);
                gameOver.putExtra("stageNo",1);
