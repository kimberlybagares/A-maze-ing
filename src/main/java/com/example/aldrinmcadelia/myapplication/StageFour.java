...
public class StageFour extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        OurSong = MediaPlayer.create(StageFour.this,R.raw.stage_sound);
        ...
        Yes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent stage = new Intent(com.example.aldrinmcadelia.myapplication.StageFour.this,StagePage.class);
                startActivity(stage);
                finish();
            }
        });
    ...
    private int loadSavedPreferences() {
        ...
        return sharedPreferences.getInt("Stage4", 86400000);
    }
        ...
        public void run() {
            ...
            while (ball.getI()!=numMaze.getRow()-1 || ball.getJ()!=numMaze.getColumn()-1){
                try {
                    ...
                    canvas.drawText("Stage 4", (width-1*str1.toString().length())/(float)20, (height-numMaze.getRight()+numMaze.getOffset())/(float)2, nPaint);
                    canvas.drawText("Limit: 25s", (width-1*str1.toString().length())/(float)1.5, (height-numMaze.getRight()+numMaze.getOffset())/(float)1.5, mPaint);
            ...
            if(gameOver!=true){
                if(timer<Btime){
                    Intent finish = new Intent(com.example.aldrinmcadelia.myapplication.StageFour.this,StagePage.class);
                    finish.putExtra("finish",timer);
                    finish.putExtra("stage", 4);
                ...
                if(timer>Btime){
                    Intent finish = new Intent(com.example.aldrinmcadelia.myapplication.StageFour.this,FinishActivity.class);
                    finish.putExtra("finish",timer);
                    finish.putExtra("stage", 4);
            ...
            if(gameOver==true){
                finish();
                Intent gameOver = new Intent(com.example.aldrinmcadelia.myapplication.StageFour.this,GameOver.class);
                gameOver.putExtra("stageNo",4);
