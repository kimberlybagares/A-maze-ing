    ...
    class MyThread implements Runnable{
        ...
        public void run() {
            ...
            if(gameOver!=true){
                ...
                Intent finish = new Intent(com.example.aldrinmcadelia.myapplication.StageSix.this,FinishActivity.class);
            ...
            if(gameOver==true){
                finish();
                startActivity(new Intent(com.example.aldrinmcadelia.myapplication.StageSix.this,GameOver.class));
            }
        }
    }
