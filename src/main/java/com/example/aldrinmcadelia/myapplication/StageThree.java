...
public class StageThree extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        OurSong = MediaPlayer.create(StageThree.this,R.raw.stage_sound);
        ...
        Yes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent stage = new Intent(com.example.aldrinmcadelia.myapplication.StageThree.this,StagePage.class);
                startActivity(stage);
                finish();
            }
        });
    ...
    private int loadSavedPreferences() {
        ...
        return sharedPreferences.getInt("Stage3Time", 25000);
    }
...
//        Thread.currentThread().interrupt();
    ...
    class MyThread implements Runnable{
        ...
        public void run() {
            ...
            if(gameOver!=true){
                if(timer<Btime){
                    Intent finish = new Intent(com.example.aldrinmcadelia.myapplication.StageThree.this,StagePage.class);
