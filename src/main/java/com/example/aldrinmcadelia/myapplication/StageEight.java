...
public class StageEight extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Yes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent stage = new Intent(com.example.aldrinmcadelia.myapplication.StageEight.this,StagePage.class);
                startActivity(stage);
                finish();
            }
        });
        ...
        public void run() {
            ...
            while (ball.getI()!=numMaze.getRow()-1 || ball.getJ()!=numMaze.getColumn()-1){
                try {
                    ...
                    canvas.drawText("Stage 8", (width-1*str1.toString().length())/(float)20, (height-numMaze.getRight()+numMaze.getOffset())/(float)2, nPaint);
            ...
            if(gameOver!=true){
                ...
                if(timer<Btime){
                    Intent finish = new Intent(com.example.aldrinmcadelia.myapplication.StageEight.this,StagePage.class);
            ...
            if(gameOver==true){
                finish();
                Intent gameOver = new Intent(com.example.aldrinmcadelia.myapplication.StageEight.this,GameOver.class);
                gameOver.putExtra("stageNo",8);
